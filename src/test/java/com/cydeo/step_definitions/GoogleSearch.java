...
public class GoogleSearch {
    ...
    public void user_should_see_in_the_result(String capitolCity) {

        Assert.assertEquals(capitolCity,googleSearchPage.capitolText.getText());
    ...
    public void user_should_be_able_to_search_for_following(List<String> searchKeywords) {
        System.out.println("searchKeyword: "+searchKeywords);
